...
infoLogPath = os.path.abspath(os.path.join(infoLogDir, str(time.asctime()).replace(' ', '_').replace(':', '_')))
debugLogPath = os.path.abspath(os.path.join(debugLogDir, str(time.asctime()).replace(' ', '_').replace(':', '_')))
errorLogPath = os.path.abspath(os.path.join(errorLogDir, str(time.asctime()).replace(' ', '_').replace(':', '_')))
criticalLogPath = os.path.abspath(os.path.join(criticalLogDir, str(time.asctime()).replace(' ', '_').replace(':', '_')))
warningLogPath = os.path.abspath(os.path.join(warningLogDir, str(time.asctime()).replace(' ', '_').replace(':', '_')))
