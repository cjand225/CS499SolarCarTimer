...
class TestSemiAutoWidget(unittest.TestCase):
    ...
    def testAddCar(self):
        ...
        self.assertEqual(testCar.carOrg,semiAutoWidget.buttonsLayout.itemAtPosition(0,SemiAutoWidget.labelColumn).widget().text())
    ...
    def testSetCar(self):
        ...
        self.assertEqual(newCar.carOrg,semiAutoWidget.buttonsLayout.itemAtPosition(0,SemiAutoWidget.labelColumn).widget().text())
        semiAutoWidget.close()
    ...
    def testDeleteCar(self):
        ...
        self.assertEqual(newCars[1].carOrg,semiAutoWidget.buttonsLayout.itemAtPosition(1,SemiAutoWidget.labelColumn).widget().text())
        semiAutoWidget.deleteCarAtIndex(0)
        self.assertEqual(newCars[1],semiAutoWidget.cars[0])
        self.assertEqual(newCars[1].carOrg,semiAutoWidget.buttonsLayout.itemAtPosition(0,SemiAutoWidget.labelColumn).widget().text())
        semiAutoWidget.close()
